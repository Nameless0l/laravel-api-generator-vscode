...
- The **diagram button** renders your entities and their relationships
  as an interactive graph

The **status bar item** shows how many entities the project has, and the
**Quick Actions** in the generator form run migrations, seeders, tests
and open the API docs without leaving the editor.
